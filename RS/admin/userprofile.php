...
$sql=mysqli_query($db,"update customer_orders set status='$status' where o_id='$form_id'");
...
$ret1=mysqli_query($db,"select * FROM customer_orders where o_id='".$_GET['newform_id']."'");
$ro=mysqli_fetch_array($ret1);
$ret2=mysqli_query($db,"select * FROM customer where customer_id='".$ro['customer_id']."'");
