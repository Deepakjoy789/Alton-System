                            ...
                            <div class="card-header">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT customer.*, customer_orders.* FROM customer INNER JOIN customer_orders ON customer.customer_id=customer_orders.customer_id where o_id='".$_GET['user_upd']."'";
